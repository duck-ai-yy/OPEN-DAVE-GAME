...
| J / 空格连打 | 中大型鱼挣扎收线 |
| E（浅水区） | 上浮结束下潜（渔获入账） |
| E（贴近保护动物） | 喂食（消耗 1 条渔获，好感满 3 成伙伴） |
| Q | 电击器（需合成：水母碎片 ×5），范围麻痹 |
| F2 | P2 随时加入/退出（同屏双人） |
| P2：方向键 / Shift / Ctrl / 回车 | 移动 / 鱼叉 / 收线 / 交互 |
| ESC | 放弃本潜（渔获不入账） |
...
**P1 已实装**：3 个可解锁地域（红海/大堡礁 1200 金/沉船 3000 金，含高价文物打捞）· 同屏双人（F2 drop-in，共享氧气背包，双人中点相机缩放）· 生物碎片合成（水母→电击器）· 保护动物喂食好感 → 海龟伙伴（+30 氧）· 生物图鉴。
